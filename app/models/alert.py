...
class Alert(BaseModelDB):
    ...
    Campos:
      ...
      - source_type: tipo de fuente (ej. dependabot, snyk)
      - title: título legible del hallazgo
      - location: archivo o path afectado
      - external_references_score: score externo (ej. CVSS)
    ...
    source_type: str | None = Field(None, description='Tipo de fuente (ej. dependabot, snyk).')
    title: str | None = Field(None, description='Título legible del hallazgo.')
    location: str | None = Field(None, description='Archivo o path afectado.')
    external_references_score: float | None = Field(None, description='Score externo (ej. CVSS).')
